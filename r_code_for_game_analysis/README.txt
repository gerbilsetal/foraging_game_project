...
and additional three datasets derived from the former files (the directions for building them are presented and coded in the R files), 
...
3. general_data.csv: dataset produced by the questionnaire the participants filled, including only the sex and age of the participants.
